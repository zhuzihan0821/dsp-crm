...
;(function($, window, undefined){
	...
	$(document).ready(function()
	{
		...
		$(".has-sub > ul > li").each(function(index,element){
				$(this).click(function(){
					$(this).toggleClass("active");
					$(this).siblings().removeClass("active");
					$(this).parent().parent(".has-sub").addClass("active").siblings().removeClass("active");
					$(this).parent().parent(".has-sub").siblings().find("li").removeClass("active");
				})
		})
