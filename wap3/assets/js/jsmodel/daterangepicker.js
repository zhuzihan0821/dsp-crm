            ...
            options.template  = '<div class="daterangepicker dropdown-menu">' +
                                    ...
                                    '<div class="ranges ranges_1">' +
                                        '<div class="range_inputs">' +
                                            ...
                                            '<button class="resetBtn" type="button">重置</button>' +
                                        '</div>' +
                                    '</div>' +
...
//          list += '<li>' + this.locale.customRangeLabel + '</li>';
        ...
        this.container.find('.ranges')
            ...
            .on('click.daterangepicker', 'button.resetBtn', $.proxy(this.clickResetBtn, this))
...
//      	//console.log('我是第6个方法');
            ...
            if ((!minDate || minDate.isBefore(calendar.firstDay)) && (!this.linkedCalendars || side == 'left')) {
                html += '<th class="prev available"><i class="icon iconfont icon-danxian-zuojiantou glyphicon"></i></th>';
            } else {
                html += '<th></th>';
            }
            ...
            if ((!maxDate || maxDate.isAfter(calendar.lastDay)) && (!this.linkedCalendars || side == 'right' || this.singleDatePicker)) {
                html += '<th class="next available"><i class="icon iconfont icon-danxian-youjiantou glyphicon"></i></th>';
            } else {
                html += '<th></th>';
            }
...
//            this.hide();
        ...
        clickResetBtn: function(e) {
            $('#daterange-btn span').html('请选择时间段 <i class="icon iconfont icon-calendar1"></i>');
            this.container.hide();
            this.isShowing = false;
        },
